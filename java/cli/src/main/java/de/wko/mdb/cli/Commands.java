...
public class Commands {
    ...
    public static final String CMD_REMOVE_CONTENT  = C1_REMOVE + " " + C2_CONTENT;
    public static final String CMD_OPEN_ARCHIVE  = C1_OPEN + " " + C2_ARCHIVE;
    public static final String CMD_CHANGE_DIR = "cd";
    public static final String CMD_LIST_HOSTS = C1_LIST + " "+ C2_HOSTS;
}
